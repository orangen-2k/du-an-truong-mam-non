            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <div class="row">
                           <div class="col-6">
                            <select class="form-control m-input form-control-sm" style="width: 30%" onchange="showDonNghiHocTheoThang()" id="array_thang"  data-hoc_sinh_id="">
            ...
            'thang': thang,
                ...
                response.data.forEach((element) => {
                    var date = new Date(element.ngay_bat_dau);
                        day = date.getDate();
                        $(`.ngay-${day}`).html(`<a target="_blank" href="${ route('don-nghi-hoc.show',{'id': element.id}) }"><i class="fa fa-file-alt text-warning"></i></a>`);
