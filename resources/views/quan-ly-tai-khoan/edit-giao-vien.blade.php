                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                 ...
                                                 <div class="m-separator m-separator--dashed m-separator--lg"></div>
													...
													<div class="form-group m-form__group row">
                                                        ...
                                                        src= {{($giao_vien->anh == '') ? 'https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png' :  Storage::url('../upload/'.$giao_vien->anh)}}
                                                        class="rounded mx-auto d-block mb-2" width="200px"
                                                        height="auto" id="show_img">
