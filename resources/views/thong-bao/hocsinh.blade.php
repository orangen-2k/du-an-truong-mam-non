            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <table id="table_id" style="with: 100%" class="table table-bordered">
                                ...
                                <thead class="filter">
                                    <tr>
                                        ...
                                        <td><input class="form-control" type="text" id="field_ma" style="width: 120px;"></td>
                                        <td><input class="form-control" type="text" id="field_ten" style="width: 120px;"></td>
                                        <td><input class="form-control" type="text" id="field_ngay_sinh" style="width: 120px;"></td>
                                        <td>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data->Khoi as $itemKhoi)
                                        @foreach ($itemKhoi->LopHoc as $itemLopHoc)
                                            ...
                                            <tr>
                                                <td class="text-center"><input type="checkbox" class="checkbox" data-id="{{ $itemHocSinh->user_id }}" data-lop_id="{{ $itemHocSinh->lop_id }}"></td>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="sendToPeoples()" >OK</button>
                    </div>
                </div>
            </div>
        </div>
